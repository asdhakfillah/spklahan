...
<head>
  ...
  <title>PDAM Kabupaten Grobogan</title>
    ...
    <nav class="navbar navbar-expand-sm navbar-default">
      <div id="main-menu" class="main-menu collapse navbar-collapse">
        <ul class="nav navbar-nav">
          ...
          <li class="menu-item">
            <a href="<?php echo base_url('Petugas_pusat/Lahan');?>" class="" data-toggle="" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-id-badge">
            </i>Hasil Lahan</a>
          </li>
          <li class="menu-item">
            <a href="<?php echo base_url('Petugas_pusat/Statuslahan');?>" class="" data-toggle="" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-id-badge">
            </i>Status Lahan</a>
          </li>
