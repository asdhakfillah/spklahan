...
class Statuslahan extends CI_Controller
{
    public function index()
    {
        ...
        $this->load->view('petugas_lapangan/statuslahan/index',$data_status);
    }
    public function insert($id_lahan = null)
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('petugas_lapangan/statuslahan/insert',$data);
        } else {
            $set_users = [
            ...
            redirect("Petugas_lapangan/Statuslahan");
        }
    }
}